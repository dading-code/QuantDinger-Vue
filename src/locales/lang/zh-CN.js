...
const locale = {
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR 和 MT5 需要下载 QuantDinger 本地客户端。无需部署完整后端，只需运行轻量级图形化程序即可连接云端并执行交易。',
  ...
  'profile.exchange.localDeploymentRequired': '需要本地客户端',
  'profile.exchange.localDeploymentHint': '此券商需要下载 QuantDinger 本地客户端才能使用。',
  'profile.exchange.desktopBrokersDisabledTitle': '当前环境不支持 IBKR / MT5',
  'profile.exchange.desktopBrokersDisabledFallback': '请下载 QuantDinger 本地客户端，通过轻量级图形化程序连接云端并执行MT5/IBKR交易。无需部署完整后端！',
  'profile.exchange.desktopBrokersOptionSuffix': '需下载客户端',
