...
'indicatorIde.editor.fastLessThanSlow': 'Fast line parameter must be less than slow line parameter',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR và MT5 cần tải xuống QuantDinger Local Client. Không cần triển khai backend đầy đủ, chỉ cần chạy chương trình GUI nhẹ để kết nối với đám mây và thực hiện giao dịch.',
  ...
  'profile.exchange.localDeploymentHint': 'Nhà môi giới này yêu cầu tải xuống QuantDinger Local Client để sử dụng.',
