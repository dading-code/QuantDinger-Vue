...
const locale = {
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 require downloading QuantDinger Local Client. No need to deploy the full backend, just run the lightweight GUI program to connect to the cloud and execute trades.',
  ...
  'profile.exchange.localDeploymentRequired': 'Local client required',
  'profile.exchange.localDeploymentHint': 'This broker requires downloading QuantDinger Local Client to use.',
  'profile.exchange.desktopBrokersDisabledTitle': 'IBKR / MT5 disabled on this server',
  'profile.exchange.desktopBrokersDisabledFallback': 'Please download QuantDinger Local Client, a lightweight GUI program that connects to the cloud and executes MT5/IBKR trades. No need to deploy the full backend!',
  'profile.exchange.desktopBrokersOptionSuffix': 'Client required',
